...
exports.cacheMiddleware = ({ type, storage }) => {
    ...
    return async (ctx, next) => {
        ...
        const span = (_a = ctx.tracing) === null || _a === void 0 ? void 0 : _a.rootSpan;
        ...
        if (cached && cached.response) {
            ...
            if (expiration > now) {
                ...
                span === null || span === void 0 ? void 0 : span.setTag(CACHE_RESULT_TAG, "HIT" /* HIT */);
                return;
            }
            span === null || span === void 0 ? void 0 : span.setTag(CACHE_RESULT_TAG, "STALE" /* STALE */);
            ...
            span === null || span === void 0 ? void 0 : span.setTag(CACHE_RESULT_TAG, "MISS" /* MISS */);
        }
        await next();
        if (!ctx.response) {
            return;
        ...
        if (!forceMaxAge && (noStore || (noCache && !etag))) {
            span === null || span === void 0 ? void 0 : span.log({ event: "no-local-cache-save" /* NO_LOCAL_CACHE_SAVE */, ["cache-type" /* CACHE_TYPE */]: cacheType });
            return;
        }
