...
class Catalog extends api_1.JanusClient {
    ...
    getProductsAndSkus(authMethod = 'AUTH_TOKEN', tracingConfig) {
        const metric = 'catalog-getProductsAndSkus';
        return this.http.get(routes.productsAndSkus, request_1.getRequestConfig(this.context, authMethod, metric, tracingConfig));
    }
